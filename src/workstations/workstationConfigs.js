...
const NETWORK_WORKSTATION = Object.freeze({
  ...
  focusCameraPosition: Object.freeze([-0.2, 3.2, 1.05]),
  focusCameraTarget: Object.freeze([-1.25, 0.95, 6.9]),
  technicianCameraPosition: Object.freeze([-0.2, 3.2, 1.05]),
  technicianCameraTarget: Object.freeze([-1.25, 0.95, 6.9]),
  ...
  powerCameraTarget: Object.freeze([-5.68, 1.23, 7.65]),
  pduCameraPosition: Object.freeze([-7.75, 1.58, 5.45]),
  pduCameraTarget: Object.freeze([-6.28, 0.9, 7.62]),
  workstationCameraPosition: Object.freeze([2.9, 2.55, 2.75]),
  workstationCameraTarget: Object.freeze([2.85, 0.95, 6.75]),
  pcSwitchPortCameraPosition: Object.freeze([-4.25, 1.8, 4.95]),
  pcSwitchPortCameraTarget: Object.freeze([-4.56, 1.48, 7.7]),
  pcConfigurationCameraPosition: Object.freeze([3.8, 1.9, 4.55]),
  pcConfigurationCameraTarget: Object.freeze([3.8, 1.34, 6.98]),
