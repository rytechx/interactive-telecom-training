const NETWORK_WORKSTATION_LAYOUT = Object.freeze({
  preparationBenchPosition: Object.freeze([-4.45, 0, 1.15]),
  ...
  patchPanelPreparationPosition: Object.freeze([-2.95, 1.01, 0.5]),
  switchPreparationPosition: Object.freeze([-2.95, 1.02, 1.15]),
  routerPreparationPosition: Object.freeze([-2.95, 1.02, 1.8]),
  routerPowerHomePosition: Object.freeze([-4.57, 0.98, 0.66]),
  switchPowerHomePosition: Object.freeze([-4.57, 0.98, 1.64]),
  patchCableHomePosition: Object.freeze([-5.99, 0.97, 0.48]),
  uplinkCableHomePosition: Object.freeze([-5.99, 0.97, 1.15]),
  workstationCableHomePosition: Object.freeze([-5.99, 0.97, 1.82]),
  workstationDeskPosition: Object.freeze([-9.55, 0, 1.15]),
  ...
  workstationPcPosition: Object.freeze([-10.08, 0.32, 1.18]),
  workstationMonitorPosition: Object.freeze([-9.55, 1.39, 1.02]),
