...
const NETWORK_PDU_CONFIG = Object.freeze({
  position: Object.freeze([1.38, 0.86, 0.3]),
  rotation: Object.freeze([0, -0.24, 0]),
  dimensions: Object.freeze([0.28, 1.32, 0.18]),
  facePosition: Object.freeze([1.36, 0.86, 0.41]),
  faceDimensions: Object.freeze([0.22, 1.18, 0.022]),
  accentPosition: Object.freeze([1.36, 0.86, 0.43]),
  labelPosition: Object.freeze([1.31, 1.5, 0.46]),
  mountingBracketDimensions: Object.freeze([0.34, 0.065, 0.08]),
  mountingBracketPositions: Object.freeze([
    Object.freeze([1.08, 1.28, 0.3]),
    Object.freeze([1.08, 0.5, 0.3]),
  ]),
})
...
const PDU_PORTS = Object.freeze([
  Object.freeze({
    ...
    shortLabel: '1',
    physicalLabel: '1',
    physicalLabelPosition: Object.freeze([-0.09, 0, 0.068]),
    type: NETWORK_PORT_TYPES.POWER,
    position: Object.freeze([1.36, 1.11, 0.435]),
    rotation: NETWORK_PDU_CONFIG.rotation,
    visibleDimensions: Object.freeze([0.102, 0.084]),
    hitboxDimensions: Object.freeze([0.26, 0.2, 0.18]),
    tooltipPosition: Object.freeze([-0.22, 0.14, 0.15]),
  ...
  Object.freeze({
    ...
    physicalLabelPosition: Object.freeze([-0.09, 0, 0.068]),
    type: NETWORK_PORT_TYPES.POWER,
    position: Object.freeze([1.36, 0.67, 0.435]),
    rotation: NETWORK_PDU_CONFIG.rotation,
    visibleDimensions: Object.freeze([0.102, 0.084]),
    hitboxDimensions: Object.freeze([0.26, 0.2, 0.18]),
    tooltipPosition: Object.freeze([-0.22, 0.14, 0.15]),
